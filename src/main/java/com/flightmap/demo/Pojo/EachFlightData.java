...
public class EachFlightData {
    ...
    public EachFlightData(Long flightDataId, String icao, String cid, String n, Double lo, Double la, Integer ang, Integer alt, Integer gs, String tc, Integer t, String modNumber, String dep, String arr, Date createTime, Date updateTime) {
    ...
    public void setModNumber(String modNumber) {
        this.modNumber = modNumber == null ? null : modNumber.trim();
    }
